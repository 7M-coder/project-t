"use strict";
/* build-hook-start *//*00001*/try { require('/Users/abdulrehman/.windsurf/extensions/wallabyjs.console-ninja-1.0.475-universal/out/buildHook/index.js').default({tool: 'cypress', checkSum: '20f967768e0baee03f5bc0VwoYBgAYCF8BA1ZdXAgHAgRTB1JS', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/abdulrehman/.windsurf/extensions/wallabyjs.console-ninja-1.0.475-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '20f967768e0baee03f5bc0VwoYBgAYCF8BA1ZdXAgHAgRTB1JS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
